...
class Yotimix(QMainWindow, QWidget, QThread, Ui_MainWindow, Cmd):
    ...
    def load_profiles(self):
        if str(self.devList.currentItem()) != "None":
            ...
            self.statusBar.showMessage(
                self.devList.currentItem().text() + " is clicked", 2000)
    ...
    def load_var(self):
        if str(self.profList.currentItem()) != "None":
            ...
            self.statusBar.showMessage(self.devList.currentItem().text(
            ) + " is clicked with " + self.profList.currentItem().text(), 2000)
        else:
            pass
    ...
    def setVolume(self):
        ...
        self.statusBar.showMessage(
            "amixer --quiet sset Master " + str(_v) + "%", 2000)
